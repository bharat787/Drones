...
lat,longi,alti= -35.363260, 149.168750, 40
groundspeed = 10
...
while(inp==1):
	...
	point1 = LocationGlobalRelative(lat, longi, alti)
	vehicle.simple_goto(point1, groundspeed=groundspeed)
	print(lat,longi,alti,groundspeed)
	for i in range(100):
		print(vehicle.attitude.yaw*180/math.pi, vehicle.attitude.pitch*180/math.pi, vehicle.attitude.roll*180/math.pi)
		sleep(0.1)
	lat = input("enter target lat")
	longi = input("enter target longitude")
	alti=input("enter target altitude")
	groundspeed = input("enter groundspeed")
	if (lat==0 or longi ==0 or alti ==0 or groundspeed==0):
		inp=0
